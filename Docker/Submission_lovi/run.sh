...
python /app/MT-Preparation/subwording/2-subword.py /app/target_19.model /app/source_19.model "$INPUT_TEXT_FILE" /app/split_val2023_10kto100k.vi
...
python /app/MT-Preparation/subwording/3-desubword.py /app/source_19.model /app/UN.vi.translated